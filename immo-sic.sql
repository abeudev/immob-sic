...
INSERT INTO `property` (`id`, `author_id`, `deal_type_id`, `category_id`, `city_id`, `neighborhood_id`, `metro_station_id`, `district_id`, `slug`, `bathrooms_number`, `bedrooms_number`, `max_guests`, `address`, `latitude`, `longitude`, `show_map`, `price`, `price_type`, `available_now`, `state`, `priority_number`, `created_at`, `updated_at`) VALUES
(1, 1, 2, 4, 3, 4, NULL, 1, 'beautiful-villa-for-sale-in-tampa', NULL, 5, NULL, '4935 New Providence Ave, Tampa, FL', '27.932255', '-82.533187', 1, 1600, 'sq. foot', NULL, 'published', 0, '2021-11-12 13:18:18', '2021-11-12 13:18:18'),
(2, 1, 1, 3, 2, NULL, NULL, NULL, 'stylish-two-level-penthouse-in-palm-beach', NULL, 2, 5, '101 Worth Ave, Palm Beach, FL 33480', '26.701320', '-80.033688', 1, 2000, 'mo', NULL, 'published', 0, '2021-11-12 13:18:18', '2021-11-12 13:18:18'),
(3, 1, 1, 1, 1, 1, NULL, NULL, 'bright-and-cheerful-alcove-studio', NULL, NULL, 4, '1451 Ocean Dr, Miami Beach, FL 33139', '25.785107', '-80.129460', 1, 200, 'day', NULL, 'published', 0, '2021-11-12 13:18:18', '2021-11-12 13:18:18'),
(4, 1, 1, 1, 1, 1, NULL, NULL, 'modern-one-bedroom-apartment-in-miami', NULL, 1, 2, '1451 Ocean Dr, Miami Beach, FL 33139', '25.785107', '-80.129460', 1, 250, 'day', NULL, 'published', 0, '2021-11-12 13:18:18', '2021-11-12 13:18:18'),
(5, 1, 1, 1, 2, NULL, NULL, NULL, 'bright-fully-furnished-1-bedroom-flat-on-the-2nd-floor', NULL, 1, 3, '300 S Ocean Blvd, Palm Beach, FL', '26.705007', '-80.033574', 1, 180, 'day', NULL, 'published', 0, '2021-11-12 13:18:18', '2021-11-12 13:18:18'),
(6, 2, 2, 1, 1, 2, 1, NULL, 'interesting-two-bedroom-apartment-for-sale', NULL, 2, NULL, '111 NE 2nd Ave, Miami, FL 33132', '25.775565', '-80.190125', 1, 190000, NULL, 0, 'published', 0, '2021-11-12 13:18:18', '2021-11-19 11:18:40'),
(7, 2, 1, 1, 3, 3, NULL, NULL, 'furnished-renovated-2-bedroom-2-bathroom-flat', NULL, 2, 6, '5411 Bayshore Blvd, Tampa, FL 33611', '27.885095', '-82.486153', 1, 2200, 'mo', NULL, 'published', 0, '2021-11-12 13:18:18', '2021-11-12 13:18:18');
...
ALTER TABLE `property`
  ADD CONSTRAINT `IDX_8BF21CDE12469DE2` FOREIGN KEY (`category_id`) REFERENCES `category` (`id`),
